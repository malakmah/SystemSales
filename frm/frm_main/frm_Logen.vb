...
Public Class frm_Logen
    ...
    Public Sub login(ByVal txtusername As String, ByVal txtpassword As String, Frm As Form)
        ...
        cmd.Parameters.AddWithValue("@Pass", Main_Mod.Encrypt(txtpassword))
        ...
        If dt.Rows.Count() = 1 Then
            ...
            If dr("b1") = True Then
                ...
                If Not IsDBNull(dr("image")) Then
                    ...
                    Frm_Sales.pic_User.Image = Image.FromStream(ms)
    ...
    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles btnLog.Click
        If dev_Win_1 >= 5 And dev_Win_2 >= 5 Then
    ...
    Private Sub CheckEdit1_CheckedChanged(sender As Object, e As EventArgs) Handles CheckEdit1.CheckedChanged
        ...
        If CheckEdit1.Checked = False Then
            ...
            Ptnpass.Visible = False
        End If
    End Sub

    Private Sub frm_Logen_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub SimpleButton1_Click_1(sender As Object, e As EventArgs)
        Dim frm As New frmRequestPassword
        frm.ShowDialog()
    End Sub

    Private Sub LinkLabel1_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles Ptnpass.LinkClicked
        Dim frm As New frmRequestPassword
        frm.ShowDialog()
    End Sub
End Class