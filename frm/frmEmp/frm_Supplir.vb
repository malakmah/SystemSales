...
Public Class frm_Supplir
    ...
    Private Sub SimpleButton5_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        Try
            ...
            'جزء الاضافه
            DB.Open()
            cmd = New SqlCommand("SQL_ADD_Supplir", DB.conn)
            ...
            Frm = DevExpress.XtraEditors.XtraMessageBox.Show(" تمت بنجاح عملية حفظ المورد  .. هل تريد المواصلة و وحفظ مورد جديد  ؟؟ " & Environment.NewLine & Convert.ToString(Me.TXT_NAME.Text.Trim) & " ", "تنبيه", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2)
    ...
    Private Sub SimpleButton6_Click(sender As Object, e As EventArgs) Handles btnUp.Click
        Try
            ...
            'جزء الاضافه
            DB.Open()
            cmd = New SqlCommand("SQL_MOD_Supplir", DB.conn)
            cmd.CommandType = CommandType.StoredProcedure
            cmd.Parameters.AddWithValue("@ID", TXT_ID.Text)
            cmd.Parameters.AddWithValue("Name", TXT_NAME.Text)
            cmd.Parameters.AddWithValue("@Address", TXT_ADDER.Text)
            ...
            XtraMessageBox.Show("Modified successfully", "Modified", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
    ...
    Private Sub frm_Supplir_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ck1.Checked = True
