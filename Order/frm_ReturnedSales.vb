...
Public Class frm_ReturnedSales

    Private Sub frm_ReturnedSales_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub SimpleButton2_Click(sender As Object, e As EventArgs) Handles SimpleButton2.Click
        Try
            ...
            DB.Open()
           CMD = New SqlCommand("sql_add_TBL_Returns_Sales", DB.conn)
            CMD.CommandType = CommandType.StoredProcedure

            CMD.Parameters.AddWithValue("@Returns_Sales_Id", SqlDbType.Int).Value = Convert.ToInt32(Me.TxtFacturePosId.Text.Trim)
            CMD.Parameters.AddWithValue("@Returns_Sales_Code", SqlDbType.NVarChar).Value = Convert.ToString(Me.TxtFacturePosCode.Text.Trim)
            CMD.Parameters.AddWithValue("@Returns_Sales_Date", SqlDbType.Date).Value = Format(CDate(Me.TxtFacturePosDate.Text.Trim), "yyyy-MM-dd")
            CMD.Parameters.AddWithValue("@Returns_Sales_Heure", SqlDbType.NVarChar).Value = Convert.ToString(Me.TxtFacturePosHeure.Text.Trim)
            CMD.Parameters.AddWithValue("@Returns_Sales_Customers", SqlDbType.NVarChar).Value = Convert.ToString(Me.TxtFacturePosSupplir.Text.Trim)
            CMD.Parameters.AddWithValue("@Returns_Sales_Username", SqlDbType.NVarChar).Value = Convert.ToString(Me.TxtFacturePosUsername.Text.Trim)
            CMD.Parameters.AddWithValue("@Returns_Sales_Sous_Total", SqlDbType.Decimal).Value = Convert.ToDecimal(Me.TXTFaccturePosTotal.Text.Trim)
            CMD.Parameters.AddWithValue("@Returns_Sales_Remises", SqlDbType.Decimal).Value = Convert.ToDecimal(Me.txtFacturePosRemises.Text.Trim)
            CMD.Parameters.AddWithValue("@Returns_Sales_Grand_Total", SqlDbType.Decimal).Value = Convert.ToDecimal(Me.TXT_Toitl.Text.Trim)
            CMD.ExecuteNonQuery()
            For I As Integer = 0 To Me.GridView1.DataRowCount - 1


                CMD = New SqlCommand("SQL_ADD_Returns_Sales_DETAILS", DB.conn)
                CMD.CommandType = CommandType.StoredProcedure
                CMD.Parameters.AddWithValue("@Returns_Sales_Code", SqlDbType.NVarChar).Value = Convert.ToString(Me.TxtFacturePosCode.Text.Trim)
                CMD.Parameters.AddWithValue("@Returns_Sales_Items_Barcode", SqlDbType.NVarChar).Value = Convert.ToString(Me.GridView1.GetRowCellValue(I, "GridView_Items_Barcode"))
                CMD.Parameters.AddWithValue("@Returns_Sales_Items_Name", SqlDbType.NVarChar).Value = Convert.ToString(Me.GridView1.GetRowCellValue(I, "GridView_Items_Name"))
                CMD.Parameters.AddWithValue("@Returns_Sales_Items_Prix_Vente", SqlDbType.Decimal).Value = Convert.ToDecimal(Me.GridView1.GetRowCellValue(I, "GridView_Items_Prix_Vente"))
                CMD.Parameters.AddWithValue("@Returns_Sales_Items_Quantite", SqlDbType.Int).Value = Convert.ToInt32(Me.GridView1.GetRowCellValue(I, "GridView_Items_Quntite"))
                CMD.Parameters.AddWithValue("@Returns_Sales_Items_Sous_Total", SqlDbType.Decimal).Value = Convert.ToDecimal(Me.GridView1.GetRowCellValue(I, "GridView_Items_Sous_Toal"))
                CMD.ExecuteNonQuery()
            ...
            If Frm = DialogResult.Yes Then
                Dim fr As New frmRptRuternSales
    ...
    Public Sub UPDATE_ITEMS_STORE()
        Try
            For M As Integer = 0 To Me.GridView1.DataRowCount - 1
                ...
                DB.Open()
                CMD = New SqlCommand("SQL_Mod_Reterns", DB.conn)
                CMD.CommandType = CommandType.StoredProcedure
                ...
                CMD = New SqlCommand("SQ_LMod_MASTER_Situation", DB.conn)
                CMD.CommandType = CommandType.StoredProcedure
                CMD.Parameters.AddWithValue("@POS_MASTER_Id", TxtFacturePosId.Text)
    ...
    Sub me1()
        For M As Integer = 0 To Me.GridView1.DataRowCount - 1
            Dim New_Quantity2 As Integer = Val(Me.GridView1.GetRowCellValue(M, "GridView_Items_Stock")) - Val(Me.GridView1.GetRowCellValue(M, "GridView_Items_Quntite"))
            Dim New_Quantity3 = (Me.GridView1.GetRowCellValue(M, "GridView_Items_Barcode")) & "'"
            DB.Open()
            CMD = New SqlCommand("SQL_MOD_Returns_DETAILS", DB.conn)
            CMD.CommandType = CommandType.StoredProcedure

            CMD.Parameters.AddWithValue("@POS_DETAILS_Code", TxtFacturePosCode.Text)
            CMD.Parameters.AddWithValue("@POS_DETAILS_Items_Barcode", New_Quantity3)
            CMD.Parameters.AddWithValue("@COUNT", New_Quantity2)
            CMD.ExecuteNonQuery()
            DB.Close()
        Next
